...
public class VendorProductsToDeliverCustomAdapter extends ArrayAdapter<DataModel> {
    ...
    public VendorProductsToDeliverCustomAdapter(ArrayList<DataModel> data, Context context) {
        super(context, R.layout.vendor_products_to_deliver_row_item, data);
        this.dataSet = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.vendor_products_to_deliver_row_item, parent, false);
              ...
              viewHolder[0].layout_call_customer=convertView.findViewById(R.id.layout_call_customer);
              ...
              viewHolder[0].spinner_order_status=convertView.findViewById(R.id.spinner_order_status);
        ...
        if (dataModel != null) {
            ...
            viewHolder[0].spinner_order_status.setAdapter(dataAdapter);

            ///FOR SPINNER ADAPTER END
            viewHolder[0].databaseReference = FirebaseDatabase.getInstance().getReference()
                    .child("Orders").child(dataModel.getOrder_ID());

            viewHolder[0].spinner_order_status.
                    setSelection(getIndex(viewHolder[0].spinner_order_status, dataModel.getOrder_Status()));

            viewHolder[0].spinner_order_status.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                @Override
                public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                    if (!viewHolder[0].spinner_order_status.getSelectedItem().equals(dataModel.getOrder_Status())){
//                    Toast.makeText(getContext(), ""+viewHolder[0]
//                            .spinner_order_status.getSelectedItem(), Toast.LENGTH_LONG).show();
                        viewHolder[0].databaseReference.child("Order_Status").setValue(""+viewHolder[0].spinner_order_status.getSelectedItem());
                    }
            ...
            viewHolder[0].layout_call_customer.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    getContext().startActivity(new Intent(Intent.ACTION_DIAL, Uri.fromParts("tel", "0"+dataModel.getReceiver_Phone(), null)));
                }
            });
        ...
        viewHolder[0].layout_main_parent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (dataModel != null) {
                    ...
                    bundle.putString("user_type", dataModel.getProduct_Vendor_Type()+"");
